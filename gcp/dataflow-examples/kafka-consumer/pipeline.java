...
import packagename.kafkaconsumer;
...
//        options.setRunner(DirectRunner.class);
        ...
        PCollection<String>  kafkapayload =    p.apply("Reading the topic" ,KafkaIO.<Long,String>read().withBootstrapServers("kafkaserver:9092")
                .withTopic("topic").withKeyDeserializer(LongDeserializer.class)
